              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    ...
                    onClick={() =>
                      decrementQuantity("quantity-calcium-bone-dog-treats")
                    }
                  >
                    -
                  </button>
                  ...
                  <button
                    ...
                    onClick={() =>
                      incrementQuantity("quantity-calcium-bone-dog-treats")
                    }
                  >
                    +
                  </button>
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-l-md"
                    onClick={() => decrementQuantity("quantity-donut-chew-toy")}
                  >
                    -
                  </button>
                  <span className="px-3 py-1 bg-gray-200">
                  ...
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-r-md"
                    onClick={() => incrementQuantity("quantity-donut-chew-toy")}
                  >
                    +
                  </button>
                </div>
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-l-md"
                    onClick={() =>
                      decrementQuantity("quantity-leather-training-leash")
                    }
                  >
                    -
                  </button>
                  ...
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-r-md"
                    onClick={() =>
                      incrementQuantity("quantity-leather-training-leash")
                    }
                  >
                    +
                  </button>
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-l-md"
                    onClick={() =>
                      decrementQuantity("quantity-nootie-flea-comb")
                    }
                  >
                    -
                  </button>
                  ...
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-r-md"
                    onClick={() =>
                      incrementQuantity("quantity-nootie-flea-comb")
                    }
                  >
                    +
                  </button>
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-l-md"
                    onClick={() =>
                      decrementQuantity("quantity-pedigree-dog-food")
                    }
                  >
                    -
                  </button>
                  ...
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-r-md"
                    onClick={() =>
                      incrementQuantity("quantity-pedigree-dog-food")
                    }
                  >
                    +
                  </button>
              ...
              <div className="flex justify-between mt-4">
                <div className="flex items-center">
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-l-md"
                    onClick={() =>
                      decrementQuantity("quantity-whiskas-cat-food")
                    }
                  >
                    -
                  </button>
                  ...
                  <button
                    className="quantity-btn px-3 py-1 bg-blue-500 text-white rounded-r-md"
                    onClick={() =>
                      incrementQuantity("quantity-whiskas-cat-food")
                    }
                  >
                    +
                  </button>
