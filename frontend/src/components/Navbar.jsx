      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img
              src="https://img.freepik.com/free-vector/supermarket-carrier-paper-bag-with-food_1284-35997.jpg?w=740&t=st=1715708646~exp=1715709246~hmac=c985390d189c57c4dff3f8b1a5660a4d2ac376860b4f9e7cbbdea89330ce545b"
              class="h-8"
              alt=" Logo"
            />
